...
export class TranslationService {
    ...
    private translations: { [key: string]: { [key: string]: string } } = {
        DE: {
            ...
            'aboutMeText1': 'Hallo! Mein Name ist Emanuel Schäfer und ich bin Frontend-Entwickler. Ich lebe in Paraguay. Ursprünglich komme ich aus Ulm, Deutschland. Es bereitet mir Freude, Dinge aus dem Nichts zu erschaffen. Getrieben von Innovation, ist es mein Ziel, zu Lösungen beizutragen, die sowohl modern als auch benutzerorientiert sind.',
            'aboutMeText2': 'Meine Fähigkeiten habe ich an der Developer Akademie erlernt, wo das Feedback von Mentoren meine Leidenschaft in Präzision verwandelte. Hier habe ich wirklich gelernt, Form und Funktion zu kombinieren, um zugängliche und ansprechende Web-Erlebnisse zu schaffen.',
        ...
        EN: {
            ...
            'mySkillsText': 'I have grown my frontend development skills that have allowed me to create different real projects.',
